...
router_noversion = APIRouter(prefix="/trainer_story_collection", tags=["trainer_story_collection"])
...
async def start_telegram(req: Request):
    ...
    return {"ok": True, "message": "Trainer Story Collection module - use /evaluate endpoint"}
